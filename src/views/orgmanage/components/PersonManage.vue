<template>
  <div>
    <div class="filter">
      ...
      <el-button @click="findMember" type="success">添加成员</el-button>
    </div>
    ...
    <el-dialog title="用户信息" :visible.sync="newMember.diglogFlag" width="500px">
      <div class="addBox">
        ...
        <div class="info">
          ...
          <el-divider></el-divider>
          <div class="info-item" style="width:300px;word-break: break-all;overflow: auto;white-space: pre-wrap;height: 60px ">
