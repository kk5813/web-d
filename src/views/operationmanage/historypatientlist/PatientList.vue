...
<script>
import { getHistoryPatientList } from "@api/operationmanage/operationmanage.js";
export default {
  data() {
    return {
      showTable: [],
      ...
      headers: [
        ...
        { label: "入院时间", value: "API_enddate", sortable: true },
      ],
      btns: [
        {
          label: "查看",
  ...
  methods: {
    patientDetails(row, index) {
      ...
      // this.$router.push("/operationmanage/historypatientdetails");
      this.$router.push({
