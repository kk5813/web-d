    ...
    >
      <div @input="formInput">
        <div>
          ...
          <el-form-item :show-message="false" label-position="left" prop="yijian">
            <template slot="label">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        "ruliang.mingcheng": [{ required: true, message: "请选择", trigger: "blur" }],
        "ruliang.fenglei": [{ required: true, message: "请选择", trigger: "blur" }],
        "ruliang.tujing": [{ required: true, message: "请选择", trigger: "blur" }],
        "ruliang.liang": [{ required: true, message: "请选择", trigger: "blur" }],

        "chuliang.mingcheng": [{ required: true, message: "请选择", trigger: "blur" }],
        "chuliang.liang": [{ required: true, message: "请选择", trigger: "blur" }],
