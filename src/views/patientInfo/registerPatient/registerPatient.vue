  ...
  <div class="global-container mt20">
    <div class="g-c-search">
      <SearchTool
          ...
          title="注册用户查询"
      >
        <el-button v-if="isZhuanJia==true" type="primary" size="small" @click="exportToExcel"> 导出数据 </el-button>
      </SearchTool>
    </div>
...
<!--        </el-table-column>-->
    ...
    <div class="page">
      <div class="block">
        ...
        >
<!--          -->
          <span  style="margin-right: 10px;  font-weight: 400; color: #606266;">共{{showTable.length}}名注册用户</span>
        </el-pagination>
      </div>
    </div>
    <!--   条件筛选对话框-->
...
import {
  getAddPatientList,
    getRigisterPatientList,
  addNewPatient,
  possiblePatientSearch, getPatientBasicInfo, deletePatient, updatePatient, searchAddPatientList,
} from "@api/patientInfo/patientinfo.js";
// eslint-disable-next-line no-unused-vars
import { searchTool } from "@utils/common.js";
import similarInfo from "../newPatient/components/similarInfo.vue";
// eslint-disable-next-line no-unused-vars
import {login} from "@api/user/user";
// eslint-disable-next-line no-unused-vars
import {isCnNewID} from "@utils/validator";
// eslint-disable-next-line no-unused-vars
...
export default {
  ...
  methods: {
    ...
    filterTable(){
      ...
      searchAddPatientList(this.filterForm).then(res=>{
        console.log(res)
      })
      // this.filtertableData=arr
      // if(this.filterForm.minAge==''){
      //   this.$message.error("请选择一个最小年龄")
      //   return
      // }else{
      //   // if(this.filterForm.maxAge==''){
      //   //   this.searchRule1[3].currentValue
      //   // }
      // }
      // console.log(this.searchRule1)
      // this.tableData=[]
    ...
    exportToExcel(){
      ...
      this.$nextTick(function () {
        ...
        // 默认导出excel文件名
        let fileName = '注册用户信息' + new Date().getTime() + '.xlsx'
  ...
  mounted() {
    getRigisterPatientList().then((res) => {
