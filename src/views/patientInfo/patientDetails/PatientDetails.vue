        ...
        <el-collapse-item name="2">
          ...
          <div>
            ...
            >
              ...
              <el-table-column width="150px" prop="isInHospital" label="是否住院">
              </el-table-column>
              <el-table-column width="150px" label="操作">
                <template slot-scope="scope">
                  <el-button size="mini" @click="getDetails(scope.row)">查看</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
...
import { getPatientHistoryInfo, addBingli } from "@api/patientInfo/patientinfo.js";
...
export default {
  ...
  methods: {
    ...
    getDetails(item) {
      this.pages.collapse_activeNames = ["1", "3"];
