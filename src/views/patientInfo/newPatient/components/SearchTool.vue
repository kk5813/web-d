      ...
      <div class="left">
        ...
        <div class="value">
          ...
          <el-input
              ...
              @change="searchMethod"
          >
            <div slot="suffix"  class="search" style="" @click="searchMethod">
              <span >搜索</span>
<!--             <el-button class="searchBtn"></el-button>-->
            </div>

<!--            -->
<!--            <el-button type="primary" icon="el-icon-search" slot="suffix"></el-button>-->
          </el-input>
          <el-select
...
export default {
  ...
  watch: {
    currentRule: function (value,oldValue) {
       // console.log("rule改变",old)

      this.$emit("ruleChange",oldValue,'')
      this.currentValue = this.currentRule.currentValue;
    },
    reset(){
      this.currentValue=this.rules[0].currentValue
...
.searchTool {
  ...
  .search:hover{
    color: #1c7e7c;
    background: rgba(28,126,124,0.2);
