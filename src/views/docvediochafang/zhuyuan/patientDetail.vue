  ...
  <div class="mainContent">
    <el-collapse v-model="pages.collapse_activeNames">
      ...
      <el-collapse-item name="1">
        ...
        <BasicPersonlInfo :prsonalInfo="patientInfo.API_basicInfo" :is-zhuayun="true" :is-show-vedio="true" @endTreat="endTreat">
        </BasicPersonlInfo>
      </el-collapse-item>
      <div class="chuyuan">
...
import Chuyuan from "./components/Chuyuan";
import Reference from "../components/Reference.vue";
import chafangLog from "../components/chafangLog";

import { getPatientsDetails, getPatientDiagRecord} from "@api/docchafang/docchafang.js";
...
export default {
  ...
  mounted() {
    ...
    // getPatientDiagRecord(this.pid).then(res => {
    //   console.log(res);
    // })
  },
  methods: {
