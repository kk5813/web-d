    ...
    <div class="info">
      <el-row>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8"
          >出生日期：{{ (prsonalInfo.API_birthday&&prsonalInfo.API_birthday.split(" ")[0]) || "无"  }}</el-col
        >
      </el-row>

      <el-row>
        <el-col :span="10">联系方式：{{ prsonalInfo.API_tel || "无" }}</el-col>
        <el-col :span="10">账号：{{ prsonalInfo.API_account || "无" }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="15"
        ...
        >
        <el-col :span="4"
          ><el-link @click="addBingli" type="success">添加病历</el-link></el-col
        >
      </el-row>
    </div>
  </div>
