        ...
        <div>
          ...
          <div style="margin-left: 80px">
            ...
            <div style="margin-top: 10px">
              ...
              <div v-for="p in consultationInfo.person.participants" :key="p.id">
                <div v-if="p.state == '已同意'" class="infoCard">
                  <template>
...
export default {
  ...
  methods: {
    ...
    //   this.$refs[
    //     "ConsultationStart"
    //   ].huizhenStart.reason = this.consultationInfo.reason;
    //   this.$refs[
    //     "ConsultationStart"
    //   ].huizhenStart.type = this.consultationInfo.type;
