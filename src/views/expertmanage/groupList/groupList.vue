  ...
  <div class="global-container mt20">
    <div>
      <SearchTool
        ...
        title="专家团队查询"
      >
        <el-button @click="newGroup.dialogFlag = true" type="success" size="small"
          >添加专家团队</el-button
        >
      </SearchTool>
    </div>
    ...
    <!-- 添加医疗机构对话框 -->
    <el-dialog title="添加机构" :visible.sync="newGroup.dialogFlag" width="700px">
      <div class="dialog">
        <el-form
          label-position="left"
          ref="addForm"
        ...
        >
          ...
          <div class="introduction">
            ...
            <div>
              <el-form-item prop="groupIntroduction">
                <el-input
                  type="textarea"
                  :rows="2"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        groupTel: [{ required: true, message: "请输入团队联系方式", trigger: "blur" }],
        groupIntroduction: [
  ...
  methods: {
    handleAvatarSuccess(res, file) {
      ...
      this.newGroup.info.groupImage = res.readloadurl;
      console.log("上传成功",this.newGroup.info.groupImage)
    },
    ...
    createGroup() {
      let imgSrc = this.newGroup.info.groupImage;
