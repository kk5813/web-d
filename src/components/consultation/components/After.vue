<template>
  <div class="after">
    ...
    <div class="org">
      <el-row :gutter="5">
        <el-col v-for="item in GroupInfo" :key="item.id" :span="4">
          <div @click="groupSelect(item)" class="orgCard">
            <div class="pic">
              <img :src="item.groupPic" alt />
<!--              <img src="https://localhost:3000/readload?url=chatfile/d3e6d7f98e54794ed784460567eb36bd.png" alt />-->
    ...
    <template v-if="currentExpertGroup.groupName">
      ...
      <div class="doc">
        <el-checkbox-group v-model="choosedExpert">
          <el-row :gutter="5">
            <el-col
              v-for="exp in currentExpertGroup.experts.slice(0, this.expShowNum)"
              :key="exp.id"
              :span="4"
            >
              <div v-if="myId != exp.expId" class="docCard">
                <div class="pic">
                  <img :src="exp.expPic" alt />
<!--                  <img src="https://localhost:3000/readload?url=chatfile/d3e6d7f98e54794ed784460567eb36bd.png" alt />-->
                </div>
                <div class="check">
                  <el-checkbox :label="exp">{{
                    `${exp.expName}(${exp.expId})`
                  }}</el-checkbox>
                </div>
              </div>
            </el-col>
            <el-col v-if="this.expShowNum < currentExpertGroup.experts.length" :span="4">
    ...
    <div class="org">
      <el-row :gutter="5">
        <el-col v-for="item in info" :key="item.id" :span="4">
        ...
        <el-checkbox-group v-model="choosedDoc">
          <el-row :gutter="5">
            <el-col
              ...
              :span="4"
            >
              <div v-if="myId != doc.docId" class="docCard">
                <div class="pic">
            ...
            <el-col v-if="this.docShowNum < currentOrg.doctors.length" :span="4">
