    ...
    <div class="treatmentLog">
      ...
      >
        ...
        <div class="treatmentLog">
          <p>
            患者状况：{{
              (item.API_patientState && item.API_patientState.join(",")) ||
              "暂无"
            }}
          </p>
          <p>
...
import { postTreatLogs } from "@api/patientInfo/patientinfo.js";
import {
  getTreatmentOptions,
  getStateOptions,
  getTreatLogs,
...
export default {
  ...
  methods: {
    ...
    saveNewLog(data) {
       console.log(data);
      let pid = this.pid;
      this.newTreatLog.API_description = data.API_treatment;
      this.newTreatLog.API_treatment = data.API_treatment;
      this.newTreatLog.time = data.time;
      this.newTreatLog.API_patientState=data.API_patientState
      this.newTreatLog.API_prescription=data.API_prescription
